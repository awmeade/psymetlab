...
#' f.adverse_impact(sat.act$gender, pass, majority.group = 2)




f.adverse_impact <- function(d.group, d.pass, majority.group, min_percent_minority = .05){
  ...
  SR.total <-  round( sum(d.pass) / total.n,3)
